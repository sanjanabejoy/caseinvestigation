...
A **NoSQL database** stores data **not in the form of tables (rows and columns)** like SQL databases.
Instead, it stores data in flexible formats like **documents (JSON-like)**.
...
3.  Schema Design (Collection + Fields)
...
5.  CRUD Operations (Frontend Implementation)
